...
import { B as Badge } from "./badge-B-x_VNB1.js";
...
import { L as LoaderCircle } from "./index-CwplnMT2.js";
import { S as ShieldCheck } from "./shield-check-CJAsWoDW.js";
import { f as format } from "./format-NdAr1oQf.js";
import "node:events";
import "node:async_hooks";
import "node:stream/web";
import "node:stream";
import "./button-CWz-4Pey.js";
import "./users-B6azN2KL.js";
const ROLES = ["admin", "doctor", "receptionist", "patient", "lab_officer"];
function Admin() {
  const {
    user: me
  } = useAuth();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center rounded-xl border bg-card p-12 text-muted-foreground", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: u.active === false ? "secondary" : "ghost", size: "sm", onClick: async () => {
          const next = !u.active;
          const {
            error
          ...
          load();
        }, children: u.active === false ? "Activate" : "Deactivate" })
      ] })
    ] }, u.id)) })
  ] });
}
