...
import { u as useAuth, L as Link } from "./router-CTu-sRtw.js";
import { c as createLucideIcon, A as Activity, B as Button } from "./button-DOu4fBLP.js";
import { a as ShieldCheck, S as Stethoscope, C as CalendarDays, F as FileText, R as Receipt } from "./stethoscope-U1M9GSyd.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative overflow-hidden border-b", style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 text-xs font-medium backdrop-blur", children: [
        ...
        " HIPAA-conscious • Role-based access"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-bold tracking-tight md:text-6xl", children: "The complete clinic, in one calm dashboard." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "container mx-auto px-4 py-16 md:py-24", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto mb-12 max-w-2xl text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold tracking-tight md:text-4xl", children: "Everything your clinic needs" }),
