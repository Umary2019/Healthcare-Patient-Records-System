import { U as jsxRuntimeExports } from "./worker-entry-CYQJekC1.js";
import { L as Link } from "./router-CTu-sRtw.js";
import { c as createLucideIcon, A as Activity, B as Button } from "./button-DOu4fBLP.js";
...
function AboutPage() {
  const values = [{
    icon: Heart,
    title: "Patient-first",
    desc: "Every workflow starts with better outcomes for patients."
  }, {
    icon: Shield,
    title: "Secure by design",
    desc: "Row-level security and role-based access on every record."
  }, {
    icon: Users,
    title: "Built for teams",
    desc: "Doctors, receptionists, and admins working in harmony."
  }];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "container mx-auto px-4 py-16 md:py-24", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-3xl text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-bold tracking-tight md:text-5xl", children: "About MediCare" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 text-lg text-muted-foreground", children: "We help clinics replace clipboards and chaos with one calm dashboard — so care teams can focus on what matters most." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto mt-14 grid max-w-4xl gap-6 sm:grid-cols-3", children: values.map((v) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border bg-card p-6 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto mb-3 flex h-11 w-11 items-center justify-center rounded-lg bg-accent text-accent-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(v.icon, { className: "h-5 w-5" }) }),
...
function SiteHeader() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "container mx-auto flex items-center justify-between px-4 py-5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden items-center gap-6 text-sm md:flex", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/about", className: "text-muted-foreground hover:text-foreground", activeProps: {
